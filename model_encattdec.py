...
from utils.decoders import attention_decoder


class EncAttentionDecoder(object):
    ...
    def build_model(self):
        ...
        outputs, logits = attention_decoder(
            cell, initial_state, enc_outputs, src_text_length, output_layer,
