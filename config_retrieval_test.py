...
train_data_hparams = {
    ...
    "datasets": [
        ...
        {
            "files": './data/essay.train.top2.global.similar5',
            "vocab_file": vocab_path,
            "max_seq_length": 15,
            "bos_token": "<BOS>",
            "eos_token": "<EOS>",
...
val_data_hparams["datasets"][3]["files"] = './data/essay.dev.top2.global.similar5'
...
test_data_hparams["datasets"][3]["files"] = './data/essay.test.top2.global.similar5'
